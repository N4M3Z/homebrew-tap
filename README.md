...
fifth tag while upstream publishes several releases a day. This formula tracks
...
dashboard beside CLIProxyAPI. Upstream publishes binaries only, no Homebrew
...
publishes it only as a per-platform notarized binary (no source tarball, no GitHub
