...
class ProtonDriveCli < Formula
  ...
  on_macos do
    on_arm do
      url "https://proton.me/download/drive/cli/0.4.6/darwin-arm64/proton-drive", using: :nounzip
      sha256 "7f579ff56aa57657f68f27ff70e322388874f57a52df6396524b14de763ce33c"
    end
    on_intel do
      url "https://proton.me/download/drive/cli/0.4.6/darwin-x64/proton-drive", using: :nounzip
  ...
  on_linux do
    on_arm do
      url "https://proton.me/download/drive/cli/0.4.6/linux-arm64/proton-drive", using: :nounzip
      sha256 "722e36559102dfb28d1897bff891961ea77ae62d63eee327bc6d132d41a2c217"
    end
    on_intel do
      url "https://proton.me/download/drive/cli/0.4.6/linux-x64/proton-drive", using: :nounzip
